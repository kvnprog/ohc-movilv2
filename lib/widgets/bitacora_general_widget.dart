...
class _ListBitacoraWidgetState extends State<ListBitacoraWidget> {
                  ...
                  child: ListView(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text('${widget.userName.toString().toLowerCase()} levantó una incidencia en ${item['lugar']} a las '),
                      )
                    ],
                  )
                )
  ...
  Widget sesionActivity(String context, String value) {
    ...
    if(value != null){
      textValue = '$title: ${dateDataConvert.dateData} a las ${dateDataConvert.hourData}';
    }else{
